...
<body>
    <table class="w-100">
        <tr>
            ...
            <td class="header2 bg-header">
                <p class="ks"><b>KARTU KONSULTASI SKRIPSI</b></p>
                <p class="semester">Mulai Sem. {{ date('Y', strtotime(Auth::user()->periode->tanggalMulai)) }} /
                    {{ date('Y', strtotime(Auth::user()->periode->tanggalMulai)) + 1 }}</p>
            </td>
        </tr>
    </table>
    <table class="kolomInfo border mt-4 w-100">
        <tr>
            ...
            <td style="width: 16%">
                <span class="text-sm" style="width: 2%"><b>{{ Auth::user()->nim }}</b></span>
            </td>
            <td style="width: 20%">
            ...
            <td style="">
                <span class="text-uppercase text-bold text-sm"><b>{{ Auth::user()->nama }}</b></span>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td colspan="4">
                <span class="text-uppercase text-bold text-sm"><b>{{ Auth::user()->judul }}</b></span>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td colspan="1">
                @foreach ($dosen1 as $dp1)
                    <span class="text-sm text-bold"><b>{{ $dp1->nama }}</b></span>
                @endforeach
            </td>
            <td>
            ...
            <td>
                @foreach ($dosen2 as $dp2)
                    <span class="text-sm text-bold"><b>{{ $dp2->nama }}</b></span>
                @endforeach
            </td>
        </tr>
    </table>
