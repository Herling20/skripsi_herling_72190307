                        ...
                        <div class="row">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-2 pb-2 flex">
                                <div class="col-6 my-auto">
                                    <h6 class="text-white text-capitalize ps-3">Data Dosen</h6>
                                </div>
                                <div class="col-6">
                                    <div class="pe-2">
                                ...
                                <tbody>
                                    @foreach ($dosen as $dsn)
                                        <tr class="">
                                            ...
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-wrap text-black text-xs font-weight-bold">{{ $dsn->nidn }}</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-wrap text-black text-xs font-weight-bold">{{ $dsn->nama }}</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-black text-xs font-weight-bold">{{ $dsn->noHp }}</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-black text-xs font-weight-bold">{{ $dsn->jumlah_milestone }}</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-black text-xs font-weight-bold">{{ $dsn->jumlah_mahasiswa }}</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <a class="text-xxs btn btn-info btn-sm bi bi-person-lines-fill"
                                                    href="{{ route('admin.detailDataDosen', $dsn->id) }}">
                                                </a>
                                                <a class="text-xxs btn btn-warning btn-sm bi bi-pencil-square"
                                                    href="{{ route('admin.editDataDosen', $dsn->id) }}">
                                                </a>
                                                <a class="text-xxs btn btn-danger btn-sm bi bi-trash3"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#hapusDataDosen{{ $dsn->id }}">
                                                </a>
                                                <div class="modal fade" id="hapusDataDosen{{ $dsn->id }}">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title text-dark">Hapus Data Dosen
                                                                </h5>
                                                                <button type="button"
