            ...
            <div class="col-12 pe-4">
                <div class="card my-table">
                        ...
                        <div class="row">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-2 pb-2 flex">
                                <div class="col-6 my-auto">
                                    <h6 class="text-white text-capitalize ps-3">Tambah Data Dosen</h6>
                                </div>
                    ...
                    <div class="card-body px-0 pb-2">
                        <form action="{{ route('admin.saveDataDosen') }}" method="POST">
                            @csrf
                            <div class="main-data-profile">
                                <div class="data-profile w-55 pe-3">
                                    ...
                                    <input type="text" name="nama" id="nama"
                                        ...
                                        value="{{ old('nama') }}" placeholder="Masukkan Nama Dosen" autofocus>
                                    @error('nama')
                                ...
                                <div class="w-100">
                                    <button type="submit" class="btn btn-success float-end">Tambah Data Dosen</button>
                                </div>
                            </div>
                        </form>
                    </div>
