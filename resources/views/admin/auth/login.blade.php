    ...
    <div class="halaman-login">
        <div class="wrapper">
            <form action="{{ route('admin.login') }}" method="POST">
                @csrf
                <h1 class="fs-3">Selamat Datang, Silahkan Login Admin</h1>
                <div class="input-box">
                    <label for="email">Email</label>
                    <input type="email" name="email" id="email" class="@error('email') is-invalid @enderror"
                        placeholder="Masukkan Email" autofocus required value="{{ old('username') }}">
                ...
                <div class="input-box">
                    ...
                    <input class="form-password" type="password" name="password" id="password"
                        placeholder="Masukkan Password" required>
                    <i class="i-password bx bxs-lock-alt"></i>
                </div>
                <div class="show-password">
                    <label for=""><input class="form-checkbox" type="checkbox" id="showPass"> Show
                        Password</label>
                </div>
